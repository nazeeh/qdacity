...
ls /usr/local/gcloud
ls /usr/local/gcloud/google-cloud-sdk
ls /usr/local/gcloud/google-cloud-sdk/bin
sudo /usr/local/gcloud/google-cloud-sdk/bin/java_dev_appserver.sh --port=8888 ./target/qdacity-war/ &
