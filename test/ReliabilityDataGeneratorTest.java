...
public class ReliabilityDataGeneratorTest {
	...
	textDocuments.add(txt); //TODO adding two times same
	...
	for(ReliabilityData rData : rDataList) {
		Logger.getLogger("logger").log(Level.INFO, "Reliability Data for CodeID "+codeIds.get(codeIdx++));
		Logger.getLogger("logger").log(Level.INFO, rData.toString());
	}
    }
