...
public class V4toV5MigrationDocumentResults implements DeferredTask {
	...
	try {
	    ...
	    Logger.getLogger(V4toV5MigrationDocumentResults.class.getName()).log(Level.SEVERE, null, ex);
	}
    }

    private void migrateDocumentResults() throws EntityNotFoundException {
