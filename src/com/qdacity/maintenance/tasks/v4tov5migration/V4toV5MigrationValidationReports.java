...
public class V4toV5MigrationValidationReports implements DeferredTask {
	...
	try {
	    ...
	    Logger.getLogger(V4toV5MigrationValidationReports.class.getName()).log(Level.SEVERE, null, ex);
	}
    }

    private void migrateValidationReports() throws EntityNotFoundException {
