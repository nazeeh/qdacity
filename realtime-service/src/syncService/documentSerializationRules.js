...
module.exports = [{
	deserialize(el, next) {
		switch(el.tagName.toLowerCase()) {
			...
			case 'span':
				if (el.className.toLowerCase() === 'size') return {
					object: 'mark',
					type: 'fontsize',
					data: Data.create({
				...
				if (el.className.toLowerCase() === 'font') return {
					object: 'mark',
					type: 'fontface',
					data: Data.create({
	...
	serialize(obj, children) {
		...
		if (obj.object === 'mark') {
			switch (obj.type) {
				case 'bold': return React.createElement('b', null, children);
				case 'italic': return React.createElement('i', null, children);
				case 'underline': return React.createElement('u', null, children);
				case 'coding': return React.createElement(
					'coding',
					{
						id: obj.data.get('id'),
				...
				case 'fontsize': return React.createElement(
					'span',
					{
						className: 'size',
				...
				case 'fontface': return React.createElement(
					'span',
					{
						className: 'font',
