...
module.exports = socketio => {
  ...
  console.log('AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA');
  console.log('AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA');
  console.log('X' +  process.env.REDIS_SOCKET + 'X');
  console.log('X' +  process.env.REDIS_HOST + 'X');
  console.log('X' +  process.env.REDIS_PORT + 'X');
  console.log('X' +  process.env.REDIS_AUTH + 'X');
  console.log('X' +  process.env.KEEP_ALIVE_INTERVAL + 'X');
  console.log('X' +  process.env.KEEP_ALIVE_TIMEOUT + 'X');
  console.log('X' +  process.env.KEEP_ALIVE_CLEANUP_INTERVAL + 'X');
  console.log('AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA');
  console.log('AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA');
  console.log('AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA');
  console.log('AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA');
