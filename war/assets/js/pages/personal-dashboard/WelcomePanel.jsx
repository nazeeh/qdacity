			...
			<Jumbotron id="welcome" >
				...
				<div>
					...
					<p><FormattedMessage
							...
							values={{
								nyt: <b><FormattedMessage id='welcomepanel.nyt' defaultMessage='NYT WS2017 at FAU' /></b>,
								nyt_link: <a onClick={this.redirectToNytProject} className="clickable">
									<FormattedMessage id='welcomepanel.this_project' defaultMessage='this project' />
								</a>
							}}
					/></p>
				</div>
