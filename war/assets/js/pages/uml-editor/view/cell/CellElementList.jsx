...
export default class Cell extends React.Component {
		...
		if (elements != null && elements.length > 0) {
			return (
				<StyledElements>
					...
					{this.props.selected ? this.renderElementAdd() : ''}
				</StyledElements>
			);
		} else {
			return <StyledElements>{this.renderElementsEmpty()}</StyledElements>;
		}
	}
	...
	renderElement(element) {
		return (
			<StyledElement>
				<StyledElementAccessibility>
					{element.getAccessibility()}
				</StyledElementAccessibility>
				...
				{this.props.selected ? (
					<StyledElementRemove
						onClick={this.removeElementClicked.bind(
							this,
