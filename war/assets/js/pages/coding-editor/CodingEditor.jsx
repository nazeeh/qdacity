			...
			<StyledSideBar>
				<StyledSideBarEditor>
					<div>
						...
						<ProjectPanel umlEditorEnabled={this.state.project.isUmlEditorEnabled()} resizeElements={this.resizeElements} codesystemView={this.codesystemViewRef} viewChanged={this.viewChanged} setSearchResults = {this.setSearchResults} project={this.state.project} history={this.props.history} documentsView = {this.documentsViewRef} />
					</div>
				</StyledSideBarEditor>
