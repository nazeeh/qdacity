...
export default class CodingOverlapText {
    ...
    updateTextLengths() {
        ...
        this.textLengthMainCode = this.getTextLength((codingIds) => codingIds.indexOf(codingIdMain) != -1);
        this.textLengthOtherCode = this.getTextLength((codingIds) => codingIds.indexOf(codingIdOther) != -1);
        this.textLengthOverlap = this.getTextLength((codingIds) => codingIds.indexOf(codingIdMain) != -1 && codingIds.indexOf(codingIdOther) != -1);
    }
