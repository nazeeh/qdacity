						...
						<div className="row">
							<div className="col-lg-5 col-sm-6">
								...
								<h2 className="section-heading">
									<FormattedMessage
										id="index.organize.title"
										defaultMessage="Organize your thoughts"
									/>
								</h2>
								<p className="lead">
									<FormattedMessage
					...
					<div className="container">
						<div className="row">
							<div className="col-lg-5 col-lg-offset-1 col-sm-push-6  col-sm-6">
								...
								<h2 className="section-heading">
									<FormattedMessage
										id="index.document.title"
										defaultMessage="Document your process"
									/>
								</h2>
								<p className="lead">
									<FormattedMessage
										id="index.document.description"
										defaultMessage="You analyze, we document."
									/>
								</p>
							</div>
					...
					<div className="container">
						<div className="row">
							<div className="col-lg-5 col-sm-6">
								...
								<h2 className="section-heading">
									<FormattedMessage
										id="index.cloud.title"
										defaultMessage="Cloud goodness"
									/>
								</h2>
								<p className="lead">
									<FormattedMessage
