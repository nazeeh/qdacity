...
export default class ParentProject extends React.Component {
	...
	render() {
		const parentProject = <StyledParentLink onClick={this.redirectToParentProject}>
			<FormattedMessage id='parentproject.parent_project' defaultMessage='Parent Project' />
		</StyledParentLink>;
