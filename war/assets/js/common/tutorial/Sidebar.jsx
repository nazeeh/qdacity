	...
	render() {
		...
		if(this.props.tutorial.tutorialState.isActive) {
			...
			<StepContainer key={data.stepNr} finish={(data.stepNr<this.props.tutorial.tutorialState.currentActiveStep)}>
				...
				<StepActionContainer isActive={false}>//TODO get active step nr and show or hide
					<ShowOkButton show={false}> //TODO get boolean from tutorialEnginge and stepNr
						<ButtonGeneric white={false}><FormattedMessage id="tutorial.ok" defaultMessage="OK"/></ButtonGeneric>
					</ShowOkButton>
				</StepActionContainer>
			</StepContainer>
			...
			return (
					<div>
						{steps}
						<CloseButtonBox>
							<ButtonGeneric white={false} onClick={function(){this.props.tutorial.tutorialEngine.closeTutorial();}.bind(this)}><FormattedMessage id="tutorial.closeTutorial" defaultMessage="Close Tutorial"/></ButtonGeneric>
						</CloseButtonBox>
					</div>
